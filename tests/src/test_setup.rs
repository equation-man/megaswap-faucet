...
pub fn initialize_protocol() { //-> MegaSwapFaucetCtx {
    //let program_id = pubkey!("9uwR3ZyHXhnA2QvPDHtjg5ei3AT9VTzst6pbzj6eQjLn");
    //let bytes = include_bytes!("../target/deploy/megaswap_vault.so");
    ...
    //    svm, initializer
    //}
    println!("This is the protocol initialization");
}
